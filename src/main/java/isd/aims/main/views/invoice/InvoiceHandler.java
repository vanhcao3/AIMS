...
import isd.aims.main.views.payment.PaymentFormHandler;
...
public class InvoiceHandler extends BaseScreenHandler {
	...
	void confirmInvoice(MouseEvent event) throws IOException {
		BaseScreenHandler paymentScreen = new PaymentFormHandler(this.stage, Configs.PAYMENT_SCREEN_PATH, invoice);
