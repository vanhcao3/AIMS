...
public class PaymentFormHandler extends BaseScreenHandler {
	...
	// public PaymentFormHandler(Stage stage, String screenPath, int amount, String contents) throws IOException {
	...
	public PaymentFormHandler(Stage stage, String screenPath, Invoice invoice) throws IOException {
		super(stage, screenPath);
    ...
    void payOrder(Response response) throws IOException {
        ...
        Map<String, String> res = ctrl.payOrder(response, 1);
